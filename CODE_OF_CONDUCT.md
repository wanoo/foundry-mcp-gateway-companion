...
**How to report, for this project:** use GitHub's private vulnerability-style
reporting on the repository where the incident happened —
[foundry-mcp-gateway](https://github.com/wanoo/foundry-mcp-gateway/security/advisories/new)
or [foundry-mcp-gateway-companion](https://github.com/wanoo/foundry-mcp-gateway-companion/security/advisories/new).
Reports go only to the maintainer and are handled confidentially. If the report
concerns the maintainer, say so — it will be handled by an uninvolved third party.
